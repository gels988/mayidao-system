...
class G2Engine {
    ...
    processRound(pVal, bVal, pPair, bPair, options = {}) {
        // Create Round Object
        ...
        const round = {
            ...
            is_natural: (pVal >= 8 || bVal >= 8),
            structureIntent: options.structureIntent || false,
            virtualS: options.virtualS, // Capture virtualS if provided
        ...
        // 4. Predict Next (Auto-update state)
                ...
                for (let r = 5; r >= 0; r--) {
                    if (this.grid[c][r] !== "") {
                        ...
                        if (!cell.markers.isTie) {
                             ...
                             cell.markers.tieCount = 1;
                        } else {
                            cell.markers.tieCount = (cell.markers.tieCount || 1) + 1;
                        }
                        return; // Done
                    }
                }
    ...
    undoLastRound() {
        ...
        console.log(`[SelfCheck] Replaying ${currentHistory.length} rounds...`);
        ...
        try {
            ...
            console.error("[SelfCheck] Replay failed:", e);
            replaySuccess = false;
        }

        // Verify Grid Consistency
        if (replaySuccess && this.history.length !== currentHistory.length) {
             console.error("[SelfCheck] History mismatch after replay!");
        }
    ...
    /**
     * Get the current grid matrix for rendering
     * @returns {Array} 2D Array of the grid
     */
    getMatrix() {
        return this.grid;
    }
